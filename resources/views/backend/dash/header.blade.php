...
<head>
    ...
    <!-- Favicon -->
    <link href="{{asset('theme/img/logo.png')}}" rel="icon">
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css" rel="stylesheet">
     <link rel="stylesheet" href="{{asset('dashmin/css/select2.min.css')}}" />
    <link rel="stylesheet" href="{{asset('dashmin/css/-5-theme.min.css')}}" />
<!-- Or for RTL support -->
...
<link href="{{asset('dashmin/css/bootstrap5.css')}}" rel="stylesheet">
<!-- For Datatable -->
...
<style>
    ...
    .sidebar {
    /*background-color: #c3c7cb;  Un vert plus foncé pour le fond du menu */
        color: #FFFFFF;
        font-size: 17px;
    }
