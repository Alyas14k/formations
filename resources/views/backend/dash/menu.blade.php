<div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-nav navbar-light">
                <a href="#" class="navbar-brand mx-4 mb-3">
                    <h4 class="text-primary"><img src="{{asset('theme/img/logo.png')}}" width="100" height="60" alt=""></h4>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('inscrit.index')}}" class="nav-item nav-link {{ Request::routeIs('inscrit.index') ? 'active' : '' }}"><i class="fas fa-user-tie me-2"></i>Inscrits</a>
                    <a href="{{route('formation.index')}}" class="nav-item nav-link {{ Request::routeIs('formation.index') ? 'active' : '' }}"><i class="fas fa-user-tie me-2"></i>Formation</a>
                    <a href="{{route('formateur.index')}}" class="nav-item nav-link {{ Request::routeIs('formateur.index') ? 'active' : '' }}"><i class="fas fa-user-tie me-2"></i>Formateur</a>
                    <a href="{{route('paiement.index')}}" class="nav-item nav-link {{ Request::routeIs('paiement.index') ? 'active' : '' }}"><i class="fas fa-user-tie me-2"></i>Paiement</a>
