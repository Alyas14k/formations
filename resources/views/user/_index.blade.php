...
<div class="rounded p-4">
        ...
        <div class="sub-header">
            <h4>LISTE DES UTILISATEURS</h2>
            <hr class="sub-header-separator">
        </div>       
                <div>
                        <button type="button" class="btn btn-outline-success me-2" data-bs-toggle="modal" data-bs-target="#adduser" data-bs-whatever=""> <i class="fa fa-plus"></i> Utilisateur </button>     
                </div>        
</div>
...
<div class="modal fade" id="adduser" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="stor" action="{{route('user.store')}}" method="POST">
        @csrf
        <div class="modal-body">        
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input class="form-check-input" name='roles[]' type="checkbox" value="{{ $role->id }}" id="flexCheckDefault">
