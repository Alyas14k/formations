...
<div class="rounded p-4">
        ...
        <div class="sub-header">
            <h4>LISTE DES ROLES</h2>
            <hr class="sub-header-separator">
        </div>       
                <div>
                        <button type="button" class="btn btn-outline-success me-2" data-bs-toggle="modal" data-bs-target="#addrole" data-bs-whatever=""> <i class="fa fa-plus"></i> Rôle </button>     
                </div>        
</div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nouveau Rôle</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form id="stor" action="{{route('role.store')}}" method="POST">
        @csrf
        <div class="modal-body">        
                ...
                <div class="row g-4">                    
                        <div class="col-md-6">
                                ...
                                <label><input type="checkbox" class="form-check-input" name=permission[] value="{{ $permission->id }}"> {{ $permission->name }}</label><br>
                                @endif
                                @endforeach                                               
                        </div>
                        <div class="col-md-6">
                                <label> <u>Permissions Gestion</u></label>
                                @foreach ($permissions as $permission )
