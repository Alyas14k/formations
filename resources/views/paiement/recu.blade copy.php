...
text/x-generic recepisse.blade.php ( HTML document, UTF-8 Unicode text, with CRLF line terminators )
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <Center><h2 style="color: green; margin-top:50px;"><u>FOLEM 2024</u></h2></Center>
    ...
    <!-- <p style="background-color: red;">Du 20 au 28 Aôut à Bobo Dioulasso </p>  -->
           ...
           <center> <p style="color: red;"><u> Fiche d'inscription N°: </u> </p></center>
       ...
       <table id="">
            ...
            <tr>
                <td><strong>Assistance Pour Hebergement :</strong></td>
